...
const Faq = () => {
    ...
    const questions = [
        ...
        { category: "참가신청", question: "JUNCTION ASIA 2025에는 누가 참가할 수 있나요?", answer: "글로벌 해커톤에 관심있는 대학생, 일반인 개발자, 디자이너, 기획자라면 누구나 참가 가능합니다." },
        { category: "참가신청", question: "혼자 참여하는 것도 가능할까요?", answer: "개별 신청은 가능하지만, 추후 팀 빌딩 세션을 통해 새로운 팀원을 만나볼 수 있습니다!" },
        { category: "참가신청", question: "팀 단위로 지원이 가능할까요?", answer: "가능합니다! 한 팀 당 최대 4인까지 참가 가능합니다. 다만, 팀 단위 지원 시 개인별 평가가 아닌, 팀단위 평가로 일부 합격은 불가능하니, 이 점 참고하시기 바랍니다." },
