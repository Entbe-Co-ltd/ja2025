...
const Contact = () => {
    ...
    const contacts = [
        { title: "파트너십 문의", url: "mailto:asia.partnership@hackjunction.com", type: "external" },
        { title: "참가자 문의", url: "mailto:asia@hackjunction.com", type: "external" },
        { title: "지원 규칙", type: "modal" },
        { title: "팀 빌딩 가이드", type: "modal" },
    ];
                        ...
                        >
                            ...
                            <div className="relative z-10">
                                ...
                                <div className="flex items-center text-neutral-400 group-hover:text-blue-400 
                                    ...
                                    {contact.title.includes("문의") ? <span className="text-sm sm:text-base">문의하기</span> : <span className="text-sm sm:text-base">확인하기</span>}
                                    <svg
